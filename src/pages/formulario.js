      ...
      <div className={styles.form}>
        ...
        <div className={styles.form_body}>
          <div className={styles.form_content}>
            ...
            Você pode ganhar um combo de Whisky Grátis em comemoração ao lançamento do filme! Preencha para resgatar
            </h2>

            <p>Promoção exclusiva somente para o mês de dezembro.</p>
          </div>
